...
function ajax(url, method) {
  var sendObj = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var csrfToken = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : csrf;
  var sendVal = '';

  if (sendObj) {
    for (var key in sendObj) {
      sendVal += "".concat(key, "=").concat(sendObj[key], "&");
    }
  ...
  return new Promise(function (resolve, reject) {
    ...
    xhr.open("POST", "".concat(url, "/").concat(method));
...
function ｄoubleClickPrevention(targetBtn) {
...
__webpack_require__(/*! /Users/yamamototeppei/study/laradock_todo/app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/yamamototeppei/study/laradock_todo/app/resources/sass/app.scss */"./resources/sass/app.scss");
